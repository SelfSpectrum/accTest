...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const paragraphHighlightToggle = document.getElementById("paragraph-highlight-toggle");
    ...
    contrastToggle.addEventListener("click", function(e) {
        ...
        contrastSubmenu.style.display = (contrastSubmenu.style.display === "block") ? "none" : "block";
    });
    ...
    contrastOptions.forEach(option => {
        option.addEventListener("click", function() {
            ...
            if (selectedContrast !== "default") {
                ...
                document.querySelectorAll('a, button, input, h1, h2, h3, h4, h5, h6, p, li, span')
                    .forEach(el => el.setAttribute('data-contrast-applied', selectedContrast));
            } else {
                // Volver al modo normal
                currentContrast = "default";
                
                // Limpiar atributos de contraste
                document.querySelectorAll('[data-contrast-applied]')
            ...
            if (selectedContrast === "default") {
                ...
                contrastToggle.textContent = "Contraste: " + this.textContent.split(" (")[0] + " ▼";
            }
    ...
    decreaseFont.addEventListener("click", function() {
        if (fontSize > 12) { // Límite inferior para evitar texto demasiado pequeño
            fontSize -= 2;
            document.body.style.fontSize = fontSize + "px";
        }
    });
    ...
    paragraphHighlightToggle.addEventListener("click", function() {
        if (!paragraphHighlightActive) {
            ...
            const highlightedParagraphs = document.querySelectorAll(".paragraph-highlighted");
    ...
    function updateUniqueFocusPosition(e) {
        if (!uniqueFocusContainer || !uniqueFocusTop || !uniqueFocusArea || !uniqueFocusBottom) {
        ...
        if (areaTop + uniqueFocusHeight > windowHeight) areaTop = windowHeight - uniqueFocusHeight;
        ...
        uniqueFocusArea.style.setProperty('height', uniqueFocusHeight + "px", 'important');
        
        uniqueFocusTop.style.setProperty('height', areaTop + "px", 'important');
        
        uniqueFocusBottom.style.setProperty('top', (areaTop + uniqueFocusHeight) + "px", 'important');
        uniqueFocusBottom.style.setProperty('height', (windowHeight - areaTop - uniqueFocusHeight) + "px", 'important');
    }
    ...
    function showUniqueFocus() {
        if (uniqueFocusContainer) {
            ...
            uniqueFocusTop.style.setProperty('background-color', 'rgba(0, 0, 0, 0.7)', 'important');
            uniqueFocusBottom.style.setProperty('background-color', 'rgba(0, 0, 0, 0.7)', 'important');
        }
    }
    ...
    function toggleUniqueFocus() {
        console.log("Ejecutando toggleUniqueFocus, estado actual:", uniqueFocusActive);
    ...
    if (focusFrameToggle) {
        ...
        console.log("Event listener del recuadro de enfoque actualizado correctamente");
    }
